...
import ErrorContextContainer from '../ErrorContextContainer/ErrorContextContainer'

// Components
import GooglePlaces from '../../components/ThirdPartyScripts/GooglePlaces/GooglePlaces'

// Styles
import styles from './ErrorPageContainer.pcss'
                              ...
                              <div style={{ opacity: (()=> isLoading === true ? 0 : 1 )() }}>
                                ...
                                {/* <MainContainer favsFullData={ favsFullData }
                                 ...
                                 {/* <FABContainer isOpen={ isOpen }
                                  ...
                                  <ErrorContextContainer toggleIsLoading={ toggleIsLoading } />
